...
class _pinjamanState extends State<pinjaman> {
  ...
  String selectedTransaksi = "Pinjaman";
  String token = "";
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Column(
                children: [
                  Wrap(
                    ...
                    children: [
                      ...List.generate(
                          nominalPinjaman.length,
                          (index) => _buildNominalButton(
                              formatCurrency(nominalPinjaman[index]),
                              selectedNominal)),
                      GestureDetector(
                        onTap: () {
                          showDialog(
              ...
              Text(
                "Minimum nominal ${formatCurrency(nominalPinjaman[0])},00",
                style: TextStyle(
                  color: Color(0xFF7B5233),
                  fontSize: 12,
                ),
              ...
              ElevatedButton(
                onPressed: isChecked
                    ? () async {
                        ...
                        if (selectedTransaksi == "Pinjaman" &&
                            data['card']['status_pinjaman'] ==
                                'Tidak Tersedia') {
                          _showStatusDialog(
                              "Pengajuan Gagal",
                              "Anda masih memiliki pinjaman aktif. Silakan tunggu hingga durasi pinjaman berakhir atau ajukan pembatalan pinjaman ke kantor cabang terdekat. Terima kasih.",
                              '/ajukan-pinjaman');
                        } else {
                          final pinjamanStatus = await DioProvider()
                              .storeUserAjukanPinjaman(
                                  token,
                                  selectedTransaksi,
                                  selectedNominal,
                                  selectedJangkaWaktu,
