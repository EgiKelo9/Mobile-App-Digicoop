...
class TransaksiTersisa extends StatefulWidget {
  const TransaksiTersisa({super.key});

  @override
  State<TransaksiTersisa> createState() => _TransaksiTersisaState();
}

class _TransaksiTersisaState extends State<TransaksiTersisa> {
  ...
  Future<void> getData() async {
    ...
    if (token.isNotEmpty) {
      final response = await DioProvider().getTransaksiTersisa(token);
      if (response != null) {
        setState(() {
          data = response;
          print(data);
                ...
                children: [
                  Expanded(
                    child: TextButton(
                      ...
                      child: const Text("Transaksi Diproses"),
                    ),
                  ),
                  SizedBox(width: 12),
                  Expanded(
